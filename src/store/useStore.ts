...
export interface SASScore { studentId: string; classId: string; semester: number; pg?: number | string; isian?: number | string; uraian?: number | string; score: number | string; }
