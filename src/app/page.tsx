          ...
          <div className="order-1 lg:order-2 flex flex-col items-center lg:items-start">
            <div className="glass relative z-10 rounded-[2.5rem] p-10 w-full max-w-md shadow-2xl border border-white/50 dark:border-slate-700/50">
              <div className="text-center mb-10">
                <img src="/logo-pai.png" alt="Logo PAI" className="w-24 h-24 mx-auto rounded-3xl shadow-xl mb-6 object-cover bg-white mix-blend-multiply dark:mix-blend-normal dark:p-1" />
        ...
        <div className="flex items-center justify-between px-4 lg:px-8 py-3.5 w-full max-w-screen-2xl mx-auto">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 group cursor-pointer">
              <img src="/logo-pai.png" alt="Logo PAI" className="w-10 h-10 rounded-lg shadow-sm transform group-hover:rotate-6 transition-transform object-cover bg-white mix-blend-multiply dark:mix-blend-normal dark:border dark:border-slate-700" />
